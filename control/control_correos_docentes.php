...
$colums=[ 'nombre', 'apellido_paterno', 'apellido_materno','correo'];
$colum=['nombre'];
$table="docente";
...
if($num_rows>0){
  while($datos=$resultado->fetch_assoc()){
      $html=$html.'
                    ...
                    <td>'.$datos['correo'].'</td>
                    <td><input class="form-check-input" type="checkbox" value="'.$datos['correo'].'" id="correo_docente[]" name="correo_docente[]"></td>
                  </tr>
